...
export default function AddPharmacy(props) {
    ...
    function addPharmacy(name,password){
        ...
        try{
          props.contract.methods.addPharmacy(name, password).send( {from: props.accounts[0], gas:3000000} )
    ...
    return(
        <div>
            ...
            <Button 
                ...
                onClick={(e)=>addPharmacy(document.getElementById('Pharmacy Name').value, document.getElementById('Pharmacy Pass').value)}
            >
                SUBMIT
            </Button>
              </div>
