...
export default function AddDCenter(props) {
    ...
    function addDCenter(name,password){
        ...
        try{
          props.contract.methods.addDCenter(name, password).send( {from: props.accounts[0], gas:3000000} )
    ...
    return(
        <div>
            ...
            <Button 
                ...
                onClick={(e)=>addDCenter(document.getElementById('Diagnostic Center Name').value, document.getElementById('Diagnostic Center Pass').value)}
            >
                SUBMIT
            </Button>
              </div>
