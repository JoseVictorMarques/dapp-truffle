...
export default function DoctorInfo(props) {
	...
	return (
		<div>
			<div>
				<input id="getDoctorWithID" className="textinput" placeholder="Doctor ID" />
			</div>
			...
			<div className="textdiv" style={{ marginTop: "60px" }}>
				{doctorName ? "Doctor Name: " + doctorName : null}
			</div>
			<div className="textdiv" style={{ marginTop: "30px" }}>
				{doctorSpecialty ? "Doctor Specialty: " + doctorSpecialty : null}
			</div>
			<div className="textdiv" style={{ marginTop: "30px" }}>
				{doctorCRM ? "Doctor CRM: " + doctorCRM : null}
			</div>
